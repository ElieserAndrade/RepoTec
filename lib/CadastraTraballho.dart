...
//
                                      ...
                                      children: [
                                        ElevatedButton(
                                          onPressed: () {
                                            ...
                                            Upado(context);
                                            uploadDados();
                                            uploadFile(_fileName,_paths.first.path);
                                          },
                                          child: Text('Publicar'),
                                          style: ButtonStyle(
                                            backgroundColor:
  ...
  uploadFile(String nome, String pasta) async {
    String uploadurl =
        "https://rumanian-straighten.000webhostapp.com/repo/upar.php";


       // var arquivo = http.MultipartFile.fromPath('file', pasta);
