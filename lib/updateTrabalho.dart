...
//
  ...
  void initState() {
    teste();
    myController.text = widget.dev1;
    myController1.text = widget.dev2;
    myController2.text = widget.dev3;
    dropCurso = widget.curso;
    dropCiclo = widget.ciclo;
    dropProjeto = widget.projeto;
    myControllerT.text = widget.titulo;
    myControllerO.text = widget.orientador;
    myControllerR.text = widget.resumo;
    super.initState();
  }
